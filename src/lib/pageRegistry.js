...
export const PAGE_GROUPS = [
  ...
  },
  {
    ...
    pages: [
      ...
      { path: "/production/cost-report", label: "تقرير تكاليف الإنتاج", section: "costs" },
  ...
  },
  {
    ...
    pages: [
      ...
      { path: "/archive", label: "أرشيف المستندات", section: "dashboard" },
  ...
  },
  {
    ...
    pages: [
      ...
      { path: "/contact", label: "تواصل معنا", section: "dashboard" },
    ],
  },
];
