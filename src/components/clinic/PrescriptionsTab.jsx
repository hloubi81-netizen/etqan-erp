...
const emptyForm = { patient_id: "", date: new Date().toISOString().split("T")[0], doctor_name: "", diagnostic_status: "", items: [], notes: "" };
...
export default function PrescriptionsTab() {
  ...
  const columns = [
    ...
    { key: "diagnostic_status", label: "الحالة التشخيصية" },
        ...
        <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-3">
            ...
            <div><Label>الحالة التشخيصية</Label>
              <Input value={form.diagnostic_status} onChange={(e) => setForm({ ...form, diagnostic_status: e.target.value })} placeholder="اكتب الحالة التشخيصية" />
            </div>
            <div>
